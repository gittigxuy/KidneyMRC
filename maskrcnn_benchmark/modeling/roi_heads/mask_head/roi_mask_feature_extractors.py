...
from ..box_head.roi_box_feature_extractors import SENet50Conv5ROIFeatureExtractor, ResNet50Conv5ROIFeatureExtractor
...
_ROI_MASK_FEATURE_EXTRACTORS = {
    ...
    "SENet50Conv5ROIFeatureExtractor": SENet50Conv5ROIFeatureExtractor,
