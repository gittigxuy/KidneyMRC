...
def resize_image_file(img_path, image_size, save_path):
    ...
    im = cv2.rectangle(im,(390, 60), (400, 70),color=(255, 255 , 255), thickness=3)
...
if __name__ == '__main__':
    src_path = '/media/bong6/602b5e26-f5c0-421c-b8a5-08c89cd4d4e6/data/yonsei2/dataset/SegMrcn_04_19/seg/bg'
    dst_path = '/media/bong6/602b5e26-f5c0-421c-b8a5-08c89cd4d4e6/data/yonsei2/dataset/SegMrcn_04_19/seg/bg_re'
